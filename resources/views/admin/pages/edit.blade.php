	...
	<div class="content">
		<div class="container">
			<div class="row">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('page.update',$page->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                {{method_field('PUT')}}
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      is-invalid @enderror" id="name" name="name" placeholder="Enter Name" value="{{$page->name}}">
                      @error('name')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      is-invalid @enderror" id="title" name="title" placeholder="Enter Title" value="{{$page->title}}">
                      @error('title')
                        <span class="invalid-feedback">{{$message}} </span>           
                      @enderror
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      is-invalid @enderror" id="keywords" name="keywords" placeholder="Enter keywords" value="{{$page->meta_keyword}}">
                      @error('keywords')
                        <span class="invalid-feedback">{{$message}} </span>           
                      @enderror
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      is-invalid @enderror" id="author" name="author" placeholder="Enter author" value="{{$page->meta_author}}">
                      @error('author')
                        <span class="invalid-feedback">{{$message}} </span>           
                      @enderror
                    </div>
