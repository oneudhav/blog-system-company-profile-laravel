		...
		<div class="container">
			<div class="row">
              ...
              <div class="card-header">
                <h3 class="card-title">New Carousel</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('carousels.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8 mt-2">
                      <img class="img-fluid"  src="{{asset('admin/dist/img/photo4.jpg')}}">
                    </div>
                    @error('image')
                        <span class="invalid-feedback">{{$message}} </span>           
                      @enderror
